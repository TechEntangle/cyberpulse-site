// ─────────────────────────────────────────────────────────────────
// CyberPulse · Confirmation email template (ESM, Workers-compatible)
//
// ESM re-implementation of email/confirm-template.js for the
// Cloudflare Worker. Keeps the same branded HTML + plain-text
// output. The original CJS version remains for Node.js CLI use.
// ─────────────────────────────────────────────────────────────────

export function buildConfirmEmail({ email, confirmUrl }) {
